...
public class TwinShooter extends Subsystem {
	...
	// PID Constants
		...
		public PIDController ShootSpeedControlA = new PIDController(this.P_SHOOT,this.I_SHOOT,this.D_SHOOT,new EncoderWrapperA(), new HoldShooterOutputA());
		public static double holdShootA;
		public PIDController ShootSpeedControlB = new PIDController(this.P_SHOOT,this.I_SHOOT,this.D_SHOOT,new EncoderWrapperB(), new HoldShooterOutputB());
