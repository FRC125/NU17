...
public class DrivetrainGyro extends Subsystem {
	...
	public PIDController driveDistanceControl = new PIDController(RobotMap.P_DRIVE, RobotMap.I_DRIVE,RobotMap.D_DRIVE,new EncoderWrapper(), new DriveOutput());
    public PIDController holdHeading = new PIDController(RobotMap.P_HEADING, RobotMap.I_HEADING, RobotMap.D_HEADING, new GyroWrapper(), new GyroOutput());
