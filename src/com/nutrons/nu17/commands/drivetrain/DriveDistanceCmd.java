...
public class DriveDistanceCmd extends Command {
  ...
  protected void initialize() {
    ...
    Robot.DRIVETRAIN.FRONT_LEFT.setPID(Robot.DRIVETRAIN.P_DRIVE, Robot.DRIVETRAIN.I_DRIVE,
        Robot.DRIVETRAIN.D_DRIVE);
    Robot.DRIVETRAIN.FRONT_RIGHT.setPID(Robot.DRIVETRAIN.P_DRIVE, Robot.DRIVETRAIN.I_DRIVE,
        Robot.DRIVETRAIN.D_DRIVE);
